module github.com/skycaptain/pulumi-jfrog-project/provider
...
require (
	github.com/jfrog/terraform-provider-project v1.9.0
...
require (
	...
	github.com/jfrog/terraform-provider-shared v1.26.0 // indirect

...
namespace Pulumi.JfrogProject
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.JfrogProject.version.txt");
    ...
    internal sealed class JfrogProjectResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public JfrogProjectResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}

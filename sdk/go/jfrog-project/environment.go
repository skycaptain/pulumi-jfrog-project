...
func NewEnvironment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("jfrog-project:index/environment:Environment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEnvironment(ctx *pulumi.Context,
	...
	var resource Environment
	err := ctx.ReadResource("jfrog-project:index/environment:Environment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
